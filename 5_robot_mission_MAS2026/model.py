...
class RobotMission(mesa.Model):
    ...
    """
    def __init__(self, width=15, height=10, initial_green_waste=10, initial_yellow_waste=10, initial_red_waste=10, n_green_robots=2, n_yellow_robots=2, n_red_robots=2, use_memory=True):
        super().__init__()
        self.width = width
        self.height = height
